...
public:
	...
	DEFINE_MEMBER_FN_3(UpdateAppearance, void, 0x02491820, bool unk1, u32 flags, bool changeRace);

	DEFINE_MEMBER_FN_0(UpdateChargenAppearance, void, 0x022EF524);
	DEFINE_MEMBER_FN_1(SetSkinTone, void, 0x022EF0EC, u32 skinToneIndex);
