...
public:
	...
	DEFINE_MEMBER_FN_0(IsInSpaceship, bool, 0x02DB50A4)
	DEFINE_MEMBER_FN_0(IsInSpace, bool, 0x01A95C44)
	DEFINE_MEMBER_FN_1(HasKeyword, bool, 0x013E5088, BGSKeyword*);
};
...
public:
	...
	DEFINE_MEMBER_FN_3(UpdateAppearance, void, 0x02697740, bool unk1, u32 flags, bool changeRace);

	DEFINE_MEMBER_FN_0(UpdateChargenAppearance, void, 0x024DFCC8);
	DEFINE_MEMBER_FN_1(SetSkinTone, void, 0x024DF890, u32 skinToneIndex);
