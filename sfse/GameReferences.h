...
public:
	...
	DEFINE_MEMBER_FN_0(IsInSpaceship, bool, 0x02BD97D4)
	DEFINE_MEMBER_FN_0(IsInSpace, bool, 0x019EE574)
	DEFINE_MEMBER_FN_1(HasKeyword, bool, 0x01347928, BGSKeyword*);
};
...
public:
	...
	DEFINE_MEMBER_FN_3(UpdateAppearance, void, 0x02538EC0, bool unk1, u32 flags, bool changeRace);

	DEFINE_MEMBER_FN_0(UpdateChargenAppearance, void, 0x02394924);
	DEFINE_MEMBER_FN_1(SetSkinTone, void, 0x023944EC, u32 skinToneIndex);
