...
public:
	...
	DEFINE_MEMBER_FN_0(IsInSpaceship, bool, 0x02B2D354)
	DEFINE_MEMBER_FN_0(IsInSpace, bool, 0x019B8160)
	DEFINE_MEMBER_FN_1(HasKeyword, bool, 0x0131CEC8, BGSKeyword*);
};
...
public:
	...
	DEFINE_MEMBER_FN_3(UpdateAppearance, void, 0x02491AD0, bool unk1, u32 flags, bool changeRace);

	DEFINE_MEMBER_FN_0(UpdateChargenAppearance, void, 0x022EF7C4);
	DEFINE_MEMBER_FN_1(SetSkinTone, void, 0x022EF38C, u32 skinToneIndex);
