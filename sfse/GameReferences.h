...
public:
	...
	DEFINE_MEMBER_FN_0(IsInSpaceship, bool, 0x02DB5434)
	DEFINE_MEMBER_FN_0(IsInSpace, bool, 0x01A95CD4)
	DEFINE_MEMBER_FN_1(HasKeyword, bool, 0x013E50F8, BGSKeyword*);
};
...
public:
	...
	DEFINE_MEMBER_FN_3(UpdateAppearance, void, 0x026979D0, bool unk1, u32 flags, bool changeRace);

	DEFINE_MEMBER_FN_0(UpdateChargenAppearance, void, 0x024DFF38);
	DEFINE_MEMBER_FN_1(SetSkinTone, void, 0x024DFB00, u32 skinToneIndex);
