...
public:
	...
	DEFINE_MEMBER_FN_0(IsInSpaceship, bool, 0x02C968C4)
	DEFINE_MEMBER_FN_0(IsInSpace, bool, 0x01A2E744)
	DEFINE_MEMBER_FN_1(HasKeyword, bool, 0x01381628, BGSKeyword*);
};
...
public:
	...
	DEFINE_MEMBER_FN_3(UpdateAppearance, void, 0x025EE740, bool unk1, u32 flags, bool changeRace);

	DEFINE_MEMBER_FN_0(UpdateChargenAppearance, void, 0x0243B6F4);
	DEFINE_MEMBER_FN_1(SetSkinTone, void, 0x0243B2BC, u32 skinToneIndex);
