...
{
public:
    DEFINE_MEMBER_FN_3(Allocate, void*, 0x0058AA34, size_t size, size_t alignment, bool aligned);
    DEFINE_MEMBER_FN_2(Free, void, 0x005A0A70, void* buf, bool aligned);
    DEFINE_MEMBER_FN_0(GetThreadScrapHeap, ScrapHeap*, 0x0079A5AC);
};
