...
public:
    ...
    DEFINE_MEMBER_FN_1(Construct, void, 0x03479C10, const char* apName);
    DEFINE_MEMBER_FN_0(Destroy, void, 0x03479CB4);
    DEFINE_MEMBER_FN_1(Seek_Impl, void, 0x0347A4BC, s64 iNumBytes);
    DEFINE_MEMBER_FN_1(GetBufferInfo_Impl, void, 0x03479F14, BufferInfo& info);
    DEFINE_MEMBER_FN_2(DoRead_Impl, u64, 0x03479D9C, void* apBuffer, u64 auiBytes);
    DEFINE_MEMBER_FN_2(DoWrite_Impl, u64, 0x03479E00, const void* apBuffer, u64 auiBytes);
};
