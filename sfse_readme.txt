Starfield Script Extender v0.2.5 pre-alpha
...
SFSE will support the latest version of Starfield available on Steam, currently 1.10.31. The Gamepass/MS Store version is unsupported. Do not email asking for support.
