Starfield Script Extender v0.1.3 pre-alpha
...
SFSE will support the latest version of Starfield available on Steam, currently 1.7.33. The Gamepass/MS Store version is unsupported. Do not email asking for support.
