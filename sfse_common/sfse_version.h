...
#define SFSE_VERSION_INTEGER_BETA	16
#define SFSE_VERSION_VERSTRING		"0, 0, 2, 16"
...
#define CURRENT_RELEASE_RUNTIME		RUNTIME_VERSION_1_14_74
#define CURRENT_RELEASE_SFSE_STR	"0.2.16"
